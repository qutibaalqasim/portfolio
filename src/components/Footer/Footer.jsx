...
export default function Footer() {
  return (
    <div id='Footer' className=' pt-7 bg-[#5757571c]'>
      ...
      <a href="https://www.linkedin.com/in/qalqasim">
      ...
      <div id='bottom' className='flex gap-4 justify-center flex-wrap mt-4 pb-4'>
